...
public class PostService {
  ...
  public List<Post> findAllByUserId(Long userId) {
    ...
    return postEntities.stream().map(PostMapper.INSTANCE::toPost).toList();
  }
  ...
  public Post add(Post post) {
    ...
    postObservers.forEach(postObserver -> postObserver.add(saved));
  ...
  public Post update(Post post) {
    ...
    postObservers.forEach(postObserver -> postObserver.update(saved));
  ...
  public void delete(Long id) {
    ...
    postObservers.forEach(postObserver -> postObserver.delete(id));
  }
